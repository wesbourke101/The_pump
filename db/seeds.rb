...
puts "Routes created" 
UserAdmin.create!(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, profile_img: "null", preferred_climbing_style: (['traditional', 'sport', "bouldering"]).sample, is_admin: Faker::Boolean.boolean, user_name: "wes123", password: '123' )
50.times do
